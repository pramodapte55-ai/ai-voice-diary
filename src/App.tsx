...
function App() {
  ...
  <div className="fixed inset-0 bg-white flex flex-col justify-between p-6 overflow-hidden select-none">
    ...
    {/* CENTER: The Giant Locked Speaker/Mic Symbol + Dynamic Displays */}
    <div className="flex-1 flex flex-col items-center justify-center">
      ...
      {/* Neatly Centered Conversational Examples (Hidden when text is active to avoid clutter) */}
